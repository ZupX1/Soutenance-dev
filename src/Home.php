...
<header>
    ...
    <div class="videomap">
    <a href="index.php" onclick="window.open('popup.php');"><img src="img/carte_paris.png" class="videomap1"></a>
    </div>
    <div class="play">
        <a href="index.php" onclick="window.open('popup.php');"><img src="img/play.png" class="play"></a>
    </div>
    <div class="pub2">
